(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('emotion'), require('react'), require('react-dom'), require('react-input-autosize'), require('prop-types')) :
	typeof define === 'function' && define.amd ? define(['emotion', 'react', 'react-dom', 'react-input-autosize', 'prop-types'], factory) :
	(global.Select = factory(global.emotion,global.React,global.ReactDOM,global.AutosizeInput,global.PropTypes));
}(this, (function (emotion,React,reactDom,AutosizeInput,PropTypes) { 'use strict';
	...
	var createPrimitive = function createPrimitive(Tag) {
	  return function (_ref) {
	    ...
	    return React__default.createElement(Tag, _extends({ ref: innerRef, className: emotion.css(css)
	    }, props));
	  };
	};
	...
	*/
	...
	var SelectContainer = function SelectContainer(props) {
	  ...
	  return React__default.createElement(
	    'div',
	    _extends({
	      className: cx( /*#__PURE__*/emotion.css(getStyles('container', props)), {
	  ...
	  createClass(ValueContainer, [{
	    ...
	    value: function render() {
	      ...
	      return React__default.createElement(
	        'div',
	        {
	          className: cx( /*#__PURE__*/emotion.css(getStyles('valueContainer', this.props)), {
	...
	var IndicatorsContainer = function IndicatorsContainer(props) {
	  ...
	  return React__default.createElement(
	    'div',
	    {
	      className: cx( /*#__PURE__*/emotion.css(getStyles('indicatorsContainer', props)), {
	        'indicators': true
	      }, className)
	    },
	    children
	...
	var Svg = function Svg(_ref) {
	  ...
	  return React__default.createElement('svg', _extends({
	    ...
	    width: size,
	    viewBox: '0 0 20 20',
	    className: /*#__PURE__*/ /*#__PURE__*/emotion.css({
	...
	var DownChevron = function DownChevron(props) {
	  return React__default.createElement(
	    Svg,
	    _extends({ size: 20, focusable: 'false', role: 'presentation' }, props),
	    React__default.createElement('path', { d: 'M4.516 7.548c0.436-0.446 1.043-0.481 1.576 0l3.908 3.747 3.908-3.747c0.533-0.481 1.141-0.446 1.574 0 0.436 0.445 0.408 1.197 0 1.615-0.406 0.418-4.695 4.502-4.695 4.502-0.217 0.223-0.502 0.335-0.787 0.335s-0.57-0.112-0.789-0.335c0 0-4.287-4.084-4.695-4.502s-0.436-1.17 0-1.615z' })
	  );
	};
	...
	var DropdownIndicator = function DropdownIndicator(props) {
	  ...
	  return React__default.createElement(
	    'div',
	    _extends({}, innerProps, {
	      className: cx( /*#__PURE__*/emotion.css(getStyles('dropdownIndicator', props)), {
	        'indicator': true,
	...
	var ClearIndicator = function ClearIndicator(props) {
	  ...
	  return React__default.createElement(
	    'div',
	    _extends({}, innerProps, {
	      className: cx( /*#__PURE__*/emotion.css(getStyles('clearIndicator', props)), {
	        'indicator': true,
	...
	var IndicatorSeparator = function IndicatorSeparator(props) {
	  ...
	  return React__default.createElement('span', _extends({}, innerProps, {
	    className: cx( /*#__PURE__*/emotion.css(getStyles('indicatorSeparator', props)), { 'indicator-separator': true }, className)
	  }));
	};
	...
	emotion.injectGlobal('@keyframes ', keyframesName, '{0%,80%,100%{opacity:0;}40%{opacity:1;}};');
	...
	var LoadingIndicator = function LoadingIndicator(props) {
	  ...
	  return React__default.createElement(
	    'div',
	    _extends({}, innerProps, {
	      className: cx( /*#__PURE__*/emotion.css(getStyles('loadingIndicator', props)), {
	        'indicator': true,
	        'loading-indicator': true
	      }, className)
	    }),
	    React__default.createElement(LoadingDot, { color: color, delay: 0, offset: isRtl }),
	    React__default.createElement(LoadingDot, { color: color, delay: 160, offset: true }),
	    React__default.createElement(LoadingDot, { color: color, delay: 320, offset: !isRtl }),
	...
	var Control = function Control(props) {
	  ...
	  return React__default.createElement(
	    ...
	    _extends({
	      ref: innerRef,
	      className: cx( /*#__PURE__*/emotion.css(getStyles('control', props)), {
	        'control': true,
	...
	var Group = function Group(props) {
	  ...
	  return React__default.createElement(
	    'div',
	    _extends({
	      className: cx( /*#__PURE__*/emotion.css(getStyles('group', props)), { 'group': true }, className)
	    }, innerProps),
	    React__default.createElement(
	      Heading,
	  ...
	  createClass(Menu, [{
	    ...
	    value: function render() {
	      ...
	      return React__default.createElement(
	        'div',
	        _extends({
	          className: cx( /*#__PURE__*/emotion.css(getStyles('menu', this.getState())), {
	            'menu': true
	          }, className),
	...
	var MenuList = function MenuList(props) {
	  ...
	  return React__default.createElement(
	    'div',
	    _extends({
	      className: cx( /*#__PURE__*/emotion.css(getStyles('menuList', props)), {
	        'menu-list': true,
	...
	var NoOptionsMessage = function NoOptionsMessage(props) {
	  ...
	  return React__default.createElement(
	    'div',
	    _extends({
	      className: cx( /*#__PURE__*/emotion.css(getStyles('noOptionsMessage', props)), {
	        'menu-notice': true,
	...
	var LoadingMessage = function LoadingMessage(props) {
	  ...
	  return React__default.createElement(
	    'div',
	    _extends({
	      className: cx( /*#__PURE__*/emotion.css(getStyles('loadingMessage', props)), {
	        'menu-notice': true,
	  ...
	  createClass(MenuPortal, [{
	    ...
	    value: function render() {
	      ...
	      var menuWrapper = React__default.createElement(
	        'div',
	        {
	          className: /*#__PURE__*/ /*#__PURE__*/emotion.css(getStyles('menuPortal', state))
	        },
	        children
	      );
	...
	var MultiValue = function (_Component2) {
	  ...
	  createClass(MultiValue, [{
	    ...
	    value: function render() {
	      ...
	      var cn = {
	        container: cx( /*#__PURE__*/emotion.css(getStyles('multiValue', this.props)), {
	          'multi-value': true,
	          'multi-value--is-disabled': isDisabled
	        }, className),
	        label: cx( /*#__PURE__*/emotion.css(getStyles('multiValueLabel', this.props)), {
	          'multi-value__label': true
	        }, className),
	        remove: cx( /*#__PURE__*/emotion.css(getStyles('multiValueRemove', this.props)), {
	      ...
	      return React__default.createElement(
	        ...
	        React__default.createElement(Remove, _extends({ className: cn.remove }, removeProps))
	      );
	    }
	  }]);
	  return MultiValue;
	...
	var Option = function Option(props) {
	  ...
	  return React__default.createElement(
	    ...
	    _extends({
	      ref: innerRef,
	      className: cx( /*#__PURE__*/emotion.css(getStyles('option', props)), {
	        'option': true,
	...
	var Placeholder = function Placeholder(props) {
	  ...
	  return React__default.createElement(
	    'div',
	    _extends({
	      className: cx( /*#__PURE__*/emotion.css(getStyles('placeholder', props)), {
	        'placeholder': true
	      }, className)
	    }, innerProps),
	    children
	...
	var SingleValue = function SingleValue(props) {
	  ...
	  return React__default.createElement(
	    'div',
	    _extends({
	      className: cx( /*#__PURE__*/emotion.css(getStyles('singleValue', props)), {
	        'single-value': true,
	  ...
	  createClass(Select, [{
	    ...
	    value: function renderMenu() {
	      ...
	      var menuElement = React__default.createElement(
	        'div',
	        null,
	        menuShouldBlockScroll ? React__default.createElement(ScrollBlock, null) : null,
	        React__default.createElement(
	          Menu,
	          _extends({}, commonProps, {
	            innerProps: {
	      ...
	      return menuPortalTarget || menuPosition === 'fixed' ? React__default.createElement(
	        MenuPortal,
	        _extends({}, commonProps, {
	  ...
	  return _temp = _class = function (_Component) {
	    ...
	    createClass(Async, [{
	      ...
	      value: function render() {
	        ...
	        return (
	          // $FlowFixMe
	          React__default.createElement(SelectComponent, _extends({}, props, {
	...
	var compareOption = function compareOption(inputValue, option, getLabel, getValue) {
	  var candidate = inputValue.toLowerCase();
	  return getValue(option).toLowerCase() === candidate || getLabel(option).toLowerCase() === candidate;
	};
	...
	var builtins = {
	  ...
	  isValidNewOption: function isValidNewOption(inputValue, selectValue, selectOptions, getLabel, getValue) {
	    if (!inputValue) return false;
	    var valueExists = selectValue.some(function (option) {
	      return compareOption(inputValue, option, getLabel, getValue);
	    });
	    if (valueExists) return false;
	    var optionExists = selectOptions.some(function (firstLevelOption) {
	      return !isOptionGroup(firstLevelOption) ? compareOption(inputValue, firstLevelOption, getLabel, getValue) : firstLevelOption.options.some(function (secondLevelOption) {
	        return compareOption(inputValue, secondLevelOption, getLabel, getValue);
	      });
	    });
	    return !optionExists;
	  },
	  ...
	  return _temp = _class = function (_Component) {
	    ...
	    createClass(Creatable, [{
	      ...
	      value: function componentWillReceiveProps(nextProps) {
	        ...
	        if (isValidNewOption(inputValue, cleanValue(value), options, this.select ? this.select.props.getOptionLabel : getOptionLabel, this.select ? this.select.props.getOptionValue : getOptionValue)) {
	...
	Select$1.AsyncCreatable = AsyncCreatable;
	Select$1.Creatable = Creatable;
